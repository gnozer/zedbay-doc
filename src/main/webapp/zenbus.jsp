	...
	<div class="row">
		...
		<div class="col hide-on-small-only m3 l2 articleNav">
			<ul class="section table-of-contents">
				...
				<li><a href="#zenbus-whatisit-cat4">Mauris pellentesque enim eu</a></li>
			</ul>
		</div>
	</div>
</article>
<article id="howitworks" class="article">
	<div class="row">
		...
		<div class="col hide-on-small-only m3 l2 articleNav">
			<ul class="section table-of-contents">
				<li><a href="#zenbus-howitworks-cat1">Introduction</a></li>
				<li><a href="#zenbus-howitworks-cat2">Aenean nec tempus ex.</a></li>
				<li><a href="#zenbus-howitworks-cat3">Pellentesque posuere</a></li>
				<li><a href="#zenbus-howitworks-cat4">Mauris pellentesque enim eu</a></li>
			</ul>
		</div>
	</div>
</article>
