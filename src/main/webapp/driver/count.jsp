...
<div class="row">
	<div class="section col s12 m12 l10" id="bodybox">
		...
		<div id="driver-comptage-cat1" class="section scrollspy">
			...
			<blockquote class="gold">Le comptage est une option
			...
			<div class="row">
				...
				<div class="col s12 m12 l4">
					...
					<img src="/images/<%= lang.toString() %>/driver_count_count.png"
						alt="" class="greyBorder smaller responsive-img materialboxed"
						data-caption="Vous pouvez compter le nombre de montées / descentes par arrêt.">
					<p>
						Pour l'arrêt concerné, vous pouvez compter le nombre de montées /
						descentes (ici avec une découpe par entreprise).<br> Une fois
						le comptage effectué, cliquez sur "J'ai terminé" pour retourner à
