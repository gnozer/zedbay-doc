...
<div class="row">
	<div class="section col s12 m12 l10" id="bodybox">
		...
		<h1>Option : Transport A la Demande</h1>
		<div id="supervision-tad-cat1" class="section scrollspy">
			<div class="row valign-wrapper">
				<div class="col s12 m12 l12">
					<blockquote class="gold">Le Transport A la Demande est
						une option payante, pour plus d'informations voir avec votre Chef
						de projet.</blockquote>
					<img src="/images/supervision_tad.png" alt=""
						class="greyBorder responsive-img materialboxed"
						data-caption="Interface TAD de la supervision">
				</div>
			</div>
			<ul class="collection">
