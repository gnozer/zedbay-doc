...
<div class="row">
			...
			<div class="row valign-wrapper">
				<div class="col s12 m12 l12">
					<blockquote class="gold">Le Comptage est une option
						payante, pour plus d'informations voir avec votre Chef de projet.
					</blockquote>
					<img src="/images/supervision_count.png" alt=""
						class="greyBorder responsive-img materialboxed"
						data-caption="Interface Comptage de la supervision">
				</div>
			</div>
			<ul class="collection">
	...
	<div class="col hide-on-small-only m3 l2 articleNav">
		<ul class="section table-of-contents">
			<li><a href="#supervision-count-cat1">Comptage</a></li>
		</ul>
	</div>
</div>