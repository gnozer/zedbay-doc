...
<article id="introduction" class="article">
	<div class="row">
		<div class="section col s12 m12 l10" id="bodybox">
			...
			<div id="supervision-introduction-cat3" class="section scrollspy">
			...
			<div id="supervision-introduction-cat4" class="section scrollspy">
		...
		<div class="col hide-on-small-only m3 l2 articleNav">
			<ul class="section table-of-contents">
				...
				<li><a href="#supervision-introduction-cat2">Aenean nec tempus ex.</a></li>
				<li><a href="#supervision-introduction-cat3">Pellentesque posuere</a></li>
				<li><a href="#supervision-introduction-cat4">Mauris pellentesque enim eu</a></li>
			</ul>
		</div>
	</div>
</article>
<article id="live" class="article">
	<div class="row">
		<div class="section col s12 m12 l10" id="bodybox">
			...
			<div id="supervision-live-cat2" class="section scrollspy">
				<h2>Aenean nec tempus ex.</h2>
				<p>
					Pellentesque suscipit ipsum eget diam ullamcorper, sodales lacinia tellus rhoncus. Duis auctor tortor non mauris fermentum, non cursus risus pretium. Donec suscipit nisi nec sollicitudin consequat. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut diam nisl, vestibulum eu elit non, suscipit tristique tortor. Nulla venenatis velit nec lacus gravida porttitor. Nulla facilisi. Nullam tincidunt dui id metus tincidunt, nec imperdiet dui mattis. Pellentesque eget lacus feugiat, tincidunt lorem fringilla, dignissim velit. Nam et nibh viverra, finibus leo ut, bibendum ex. Curabitur in arcu sem. Praesent venenatis sit amet tortor quis rhoncus. Nullam interdum arcu quis libero vestibulum egestas. Pellentesque ut orci nec dolor imperdiet facilisis. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.
				</p>
			...
			<div id="supervision-live-cat3" class="section scrollspy">
				<h2>Pellentesque posuere </h2>
				<p>
					Sed suscipit sapien augue, non porttitor tortor egestas ut. Vestibulum vel nisl augue. Integer auctor, ligula sit amet aliquam blandit, dui dolor efficitur est, id mollis risus tellus vulputate ligula. Sed accumsan varius elit quis tincidunt. Vestibulum vel sapien et urna viverra bibendum. Duis vel risus tortor. Curabitur viverra urna consectetur odio tincidunt feugiat. Vivamus vulputate odio ut quam accumsan lacinia vel in sapien. Aenean eu quam nisl.
				</p>
			...
			<div id="supervision-live-cat4" class="section scrollspy">
				<h2>Mauris pellentesque enim eu</h2>
				<p>
					In dictum pretium mauris, eu feugiat felis porta quis. Etiam lobortis lorem ut urna dictum consequat. Mauris at eleifend justo. Nam auctor mauris quis vestibulum condimentum. Integer ac velit ac ipsum fermentum placerat eget consectetur augue. Phasellus pulvinar purus dolor, sit amet tempor urna laoreet vitae. Sed vitae diam elementum, lobortis mauris non, scelerisque arcu. Nam quis porttitor est. Nam tempor nibh sit amet sagittis dapibus. Donec ut elit magna.
				</p>
		...
		<div class="col hide-on-small-only m3 l2 articleNav">
			<ul class="section table-of-contents">
				<li><a href="#supervision-live-cat1">Introduction</a></li>
				<li><a href="#supervision-live-cat2">Aenean nec tempus ex.</a></li>
				<li><a href="#supervision-live-cat3">Pellentesque posuere</a></li>
				<li><a href="#supervision-live-cat4">Mauris pellentesque enim eu</a></li>
			</ul>
		</div>
	</div>
</article>
<article id="history" class="article">
	<div class="row">
		<div class="section col s12 m12 l10" id="bodybox">
			...
			<div id="supervision-history-cat2" class="section scrollspy">
				<h2>Aenean nec tempus ex.</h2>
				<p>
					Pellentesque suscipit ipsum eget diam ullamcorper, sodales lacinia tellus rhoncus. Duis auctor tortor non mauris fermentum, non cursus risus pretium. Donec suscipit nisi nec sollicitudin consequat. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut diam nisl, vestibulum eu elit non, suscipit tristique tortor. Nulla venenatis velit nec lacus gravida porttitor. Nulla facilisi. Nullam tincidunt dui id metus tincidunt, nec imperdiet dui mattis. Pellentesque eget lacus feugiat, tincidunt lorem fringilla, dignissim velit. Nam et nibh viverra, finibus leo ut, bibendum ex. Curabitur in arcu sem. Praesent venenatis sit amet tortor quis rhoncus. Nullam interdum arcu quis libero vestibulum egestas. Pellentesque ut orci nec dolor imperdiet facilisis. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.
				</p>
			...
			<div id="supervision-history-cat3" class="section scrollspy">
				<h2>Pellentesque posuere </h2>
				<p>
					Sed suscipit sapien augue, non porttitor tortor egestas ut. Vestibulum vel nisl augue. Integer auctor, ligula sit amet aliquam blandit, dui dolor efficitur est, id mollis risus tellus vulputate ligula. Sed accumsan varius elit quis tincidunt. Vestibulum vel sapien et urna viverra bibendum. Duis vel risus tortor. Curabitur viverra urna consectetur odio tincidunt feugiat. Vivamus vulputate odio ut quam accumsan lacinia vel in sapien. Aenean eu quam nisl.
				</p>
			...
			<div id="supervision-history-cat4" class="section scrollspy">
				<h2>Mauris pellentesque enim eu</h2>
				<p>
					In dictum pretium mauris, eu feugiat felis porta quis. Etiam lobortis lorem ut urna dictum consequat. Mauris at eleifend justo. Nam auctor mauris quis vestibulum condimentum. Integer ac velit ac ipsum fermentum placerat eget consectetur augue. Phasellus pulvinar purus dolor, sit amet tempor urna laoreet vitae. Sed vitae diam elementum, lobortis mauris non, scelerisque arcu. Nam quis porttitor est. Nam tempor nibh sit amet sagittis dapibus. Donec ut elit magna.
				</p>
		...
		<div class="col hide-on-small-only m3 l2 articleNav">
			<ul class="section table-of-contents">
				<li><a href="#supervision-history-cat1">Introduction</a></li>
				<li><a href="#supervision-history-cat2">Aenean nec tempus ex.</a></li>
				<li><a href="#supervision-history-cat3">Pellentesque posuere</a></li>
				<li><a href="#supervision-history-cat4">Mauris pellentesque enim eu</a></li>
			</ul>
		</div>
	</div>
</article>
<article id="dailystoptimes" class="article">
	<div class="row">
		<div class="section col s12 m12 l10" id="bodybox">
			...
			<div id="supervision-dailystoptimes-cat2" class="section scrollspy">
				<h2>Aenean nec tempus ex.</h2>
				<p>
					Pellentesque suscipit ipsum eget diam ullamcorper, sodales lacinia tellus rhoncus. Duis auctor tortor non mauris fermentum, non cursus risus pretium. Donec suscipit nisi nec sollicitudin consequat. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut diam nisl, vestibulum eu elit non, suscipit tristique tortor. Nulla venenatis velit nec lacus gravida porttitor. Nulla facilisi. Nullam tincidunt dui id metus tincidunt, nec imperdiet dui mattis. Pellentesque eget lacus feugiat, tincidunt lorem fringilla, dignissim velit. Nam et nibh viverra, finibus leo ut, bibendum ex. Curabitur in arcu sem. Praesent venenatis sit amet tortor quis rhoncus. Nullam interdum arcu quis libero vestibulum egestas. Pellentesque ut orci nec dolor imperdiet facilisis. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.
				</p>
			...
			<div id="supervision-dailystoptimes-cat3" class="section scrollspy">
				<h2>Pellentesque posuere </h2>
				<p>
					Sed suscipit sapien augue, non porttitor tortor egestas ut. Vestibulum vel nisl augue. Integer auctor, ligula sit amet aliquam blandit, dui dolor efficitur est, id mollis risus tellus vulputate ligula. Sed accumsan varius elit quis tincidunt. Vestibulum vel sapien et urna viverra bibendum. Duis vel risus tortor. Curabitur viverra urna consectetur odio tincidunt feugiat. Vivamus vulputate odio ut quam accumsan lacinia vel in sapien. Aenean eu quam nisl.
				</p>
			...
			<div id="supervision-dailystoptimes-cat4" class="section scrollspy">
				<h2>Mauris pellentesque enim eu</h2>
				<p>
					In dictum pretium mauris, eu feugiat felis porta quis. Etiam lobortis lorem ut urna dictum consequat. Mauris at eleifend justo. Nam auctor mauris quis vestibulum condimentum. Integer ac velit ac ipsum fermentum placerat eget consectetur augue. Phasellus pulvinar purus dolor, sit amet tempor urna laoreet vitae. Sed vitae diam elementum, lobortis mauris non, scelerisque arcu. Nam quis porttitor est. Nam tempor nibh sit amet sagittis dapibus. Donec ut elit magna.
				</p>
		...
		<div class="col hide-on-small-only m3 l2 articleNav">
			<ul class="section table-of-contents">
				<li><a href="#supervision-dailystoptimes-cat1">Introduction</a></li>
				<li><a href="#supervision-dailystoptimes-cat2">Aenean nec tempus ex.</a></li>
				<li><a href="#supervision-dailystoptimes-cat3">Pellentesque posuere</a></li>
				<li><a href="#supervision-dailystoptimes-cat4">Mauris pellentesque enim eu</a></li>
			</ul>
		</div>
	</div>
</article>
<article id="providers" class="article">
	<div class="row">
		<div class="section col s12 m12 l10" id="bodybox">
			...
			<div id="supervision-providers-cat2" class="section scrollspy">
				<h2>Aenean nec tempus ex.</h2>
				<p>
					Pellentesque suscipit ipsum eget diam ullamcorper, sodales lacinia tellus rhoncus. Duis auctor tortor non mauris fermentum, non cursus risus pretium. Donec suscipit nisi nec sollicitudin consequat. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut diam nisl, vestibulum eu elit non, suscipit tristique tortor. Nulla venenatis velit nec lacus gravida porttitor. Nulla facilisi. Nullam tincidunt dui id metus tincidunt, nec imperdiet dui mattis. Pellentesque eget lacus feugiat, tincidunt lorem fringilla, dignissim velit. Nam et nibh viverra, finibus leo ut, bibendum ex. Curabitur in arcu sem. Praesent venenatis sit amet tortor quis rhoncus. Nullam interdum arcu quis libero vestibulum egestas. Pellentesque ut orci nec dolor imperdiet facilisis. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.
				</p>
			...
			<div id="supervision-providers-cat3" class="section scrollspy">
				<h2>Pellentesque posuere </h2>
				<p>
					Sed suscipit sapien augue, non porttitor tortor egestas ut. Vestibulum vel nisl augue. Integer auctor, ligula sit amet aliquam blandit, dui dolor efficitur est, id mollis risus tellus vulputate ligula. Sed accumsan varius elit quis tincidunt. Vestibulum vel sapien et urna viverra bibendum. Duis vel risus tortor. Curabitur viverra urna consectetur odio tincidunt feugiat. Vivamus vulputate odio ut quam accumsan lacinia vel in sapien. Aenean eu quam nisl.
				</p>
			...
			<div id="supervision-providers-cat4" class="section scrollspy">
				<h2>Mauris pellentesque enim eu</h2>
				<p>
					In dictum pretium mauris, eu feugiat felis porta quis. Etiam lobortis lorem ut urna dictum consequat. Mauris at eleifend justo. Nam auctor mauris quis vestibulum condimentum. Integer ac velit ac ipsum fermentum placerat eget consectetur augue. Phasellus pulvinar purus dolor, sit amet tempor urna laoreet vitae. Sed vitae diam elementum, lobortis mauris non, scelerisque arcu. Nam quis porttitor est. Nam tempor nibh sit amet sagittis dapibus. Donec ut elit magna.
				</p>
		...
		<div class="col hide-on-small-only m3 l2 articleNav">
			<ul class="section table-of-contents">
				<li><a href="#supervision-providers-cat1">Introduction</a></li>
				<li><a href="#supervision-providers-cat2">Aenean nec tempus ex.</a></li>
				<li><a href="#supervision-providers-cat3">Pellentesque posuere</a></li>
				<li><a href="#supervision-providers-cat4">Mauris pellentesque enim eu</a></li>
			</ul>
		</div>
	</div>
</article>
