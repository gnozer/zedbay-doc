...
<nav class="sectionNav">
	<h2 class="sideTitle">Zenbus Driver</h2>
	<ul id="nav-mobile" class="side-nav fixed">
		<li><a href="#instal">1. Installation</a></li>
		<li class="active"><a href="#config" class="config">2. Configuration</a></li>
		<li><a href="#faq">3. FAQ</a></li>
		<li><a href="#tuto">4. Tutorial</a></li>
	</ul>
</nav>
<article class="article">
	<div class="row config">
		<div class="section col s12 m9 l10" id="bodybox">
			...
			<div id="config" class="section scrollspy">
			...
			<div id="wifi_disabled" class="section scrollspy">
				...
				<ul class="collection">
					<li class="collection-item avatar"><i
						class="material-icons circle red">network_check</i> <span
						class="title">Notification réseau</span>
						<p>A désactiver</p></li>
					<li class="collection-item avatar"><i
						class="material-icons circle red">signal_wifi_off</i> <span
						class="title">Wifi activé en mode veille</span>
						<p>Jamais (augmente l'utilisation des donnÃ©es)</p></li>
					<li class="collection-item avatar"><i
						class="material-icons circle green">signal_cellular_connected_no_internet_4_bar</i>
						<span class="title">Eviter les connexions instables</span>
						<p>A activer</p></li>
					<li class="collection-item avatar"><i
						class="material-icons circle green">wifi_tethering</i> <span
						class="title">Recherche toujours disponible</span>
						<p>A activer</p></li>
				</ul>
			</div>
			<div id="localization" class="section scrollspy">
			...
			<div id="precision_wifi" class="section scrollspy">
		...
		<div class="col hide-on-small-only m3 l2 articleNav">
			<ul id="toc" class="section table-of-contents">
				<li><a href="#config">Introduction</a></li>
				<li><a href="#wifi_disabled">Wifi</a></li>
				<li><a href="#localization">Localisation</a></li>
				<li><a href="#precision_wifi">Amélioration précision</a></li>
			</ul>
		</div>
	</div>
</article>
